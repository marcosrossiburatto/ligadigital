class animais {
    ...
    constructor(filo, classe, ordem, familia, habitat, aceleracao, nome) {
        this.filo = filo,
        this.classe = classe,
        this.ordem = ordem,
    ...
    beberAgua() {
        ...
        this.descrever;
        console.log(" bebeu água até saciar sua sede.");
        console.log("(Sede: " + this.sede + ")");
    }
    ...
    deslocamento(posfinal) {
        if (this.posicao < posfinal) {
            ...
            while (this.posicao < posfinal) {
                ...
                console.log("Para isso teria que andar " + distancia + " metros para a esquerda, ate a Posição: " + posfinal + ".");
                while (this.posicao > posfinal) {
                    this.posicao -= this.aceleracao;
    ...
    fim() {
        ...
        console.log("a capivara imediatamente respondeu: ' -#VemSerDev! Só tem fera!'");
        console.log("--------------------------- Fim! --------------------------");
    }
}
